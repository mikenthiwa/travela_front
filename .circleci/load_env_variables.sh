...
require PRODUCTION_NODE_ENV $PRODUCTION_NODE_ENV
require PRODUCTION_GOOGLE_ANALYTICS_KEY $PRODUCTION_GOOGLE_ANALYTICS_KEY
require PRODUCTION_GOOGLE_AUTH_CLIENT_ID $PRODUCTION_GOOGLE_AUTH_CLIENT_ID
require PRODUCTION_REACT_APP_SLACK_HELP_CHANNEL $PRODUCTION_REACT_APP_SLACK_HELP_CHANNEL
require PRODUCTION_REACT_APP_VAPID_PUBLIC_KEY $PRODUCTION_REACT_APP_VAPID_PUBLIC_KEY

require QA_AUTH_REDIRECT_URL $QA_AUTH_REDIRECT_URL
require QA_API_URL $QA_API_URL
...
require STAGING_NODE_ENV $STAGING_NODE_ENV
require STAGING_GOOGLE_ANALYTICS_KEY $STAGING_GOOGLE_ANALYTICS_KEY
require STAGING_GOOGLE_AUTH_CLIENT_ID $STAGING_GOOGLE_AUTH_CLIENT_ID
require STAGING_REACT_APP_SLACK_HELP_CHANNEL $STAGING_REACT_APP_SLACK_HELP_CHANNEL
require STAGING_REACT_APP_VAPID_PUBLIC_KEY $STAGING_REACT_APP_VAPID_PUBLIC_KEY
...
require TESTING_NODE_ENV $TESTING_NODE_ENV
require TESTING_GOOGLE_ANALYTICS_KEY $TESTING_GOOGLE_ANALYTICS_KEY
require TESTING_GOOGLE_AUTH_CLIENT_ID $TESTING_GOOGLE_AUTH_CLIENT_ID
require TESTING_REACT_APP_SLACK_HELP_CHANNEL $TESTING_REACT_APP_SLACK_HELP_CHANNEL
require TESTING_REACT_APP_VAPID_PUBLIC_KEY $TESTING_REACT_APP_VAPID_PUBLIC_KEY

if [ "$1" == 'test' ]; then
  export REACT_APP_NODE_ENV=$TESTING_NODE_ENV
  ...
  export REACT_APP_GOOGLE_ANALYTICS_KEY=$TESTING_GOOGLE_ANALYTICS_KEY
  export REACT_APP_GOOGLE_AUTH_CLIENT_ID=$TESTING_GOOGLE_AUTH_CLIENT_ID
  export REACT_APP_SLACK_HELP_CHANNEL=$TESTING_REACT_APP_SLACK_HELP_CHANNEL
  export REACT_APP_VAPID_PUBLIC_KEY=$TESTING_REACT_APP_VAPID_PUBLIC_KEY
elif [ "$CIRCLE_BRANCH" == 'master' ]; then
  export REACT_APP_NODE_ENV=$PRODUCTION_NODE_ENV
  ...
  export REACT_APP_GOOGLE_ANALYTICS_KEY=$PRODUCTION_GOOGLE_ANALYTICS_KEY
  export REACT_APP_GOOGLE_AUTH_CLIENT_ID=$PRODUCTION_GOOGLE_AUTH_CLIENT_ID
  export REACT_APP_SLACK_HELP_CHANNEL=$PRODUCTION_REACT_APP_SLACK_HELP_CHANNEL
  export REACT_APP_VAPID_PUBLIC_KEY=$PRODUCTION_REACT_APP_VAPID_PUBLIC_KEY
else
  export REACT_APP_NODE_ENV=$STAGING_NODE_ENV
  # Staging will be using production's REACT_APP_ANDELA_AUTH_HOST
  ...
  # Staging will be using production's REACT_APP_ALL_USERS
  # Change PRODUCTION to STAGING to revert changes
  export REACT_APP_ALL_USERS=$PRODUCTION_ALL_USERS
  export REACT_APP_DEFAULT_LOCATION=$STAGING_DEFAULT_LOCATION
  export REACT_APP_BUGSNAG_API_KEY=$STAGING_BUGSNAG_API_KEY
  # Staging will be using production's REACT_APP_JWT_PUBLIC_KEY
  # Change PRODUCTION to STAGING to revert changes
  export REACT_APP_JWT_PUBLIC_KEY=$PRODUCTION_JWT_PUBLIC_KEY
  export REACT_APP_GOOGLE_ANALYTICS_KEY=$STAGING_GOOGLE_ANALYTICS_KEY
  export REACT_APP_GOOGLE_AUTH_CLIENT_ID=$STAGING_GOOGLE_AUTH_CLIENT_ID
  export REACT_APP_SLACK_HELP_CHANNEL=$STAGING_REACT_APP_SLACK_HELP_CHANNEL
  export REACT_APP_VAPID_PUBLIC_KEY=$STAGING_REACT_APP_VAPID_PUBLIC_KEY
fi

# inherit some environment variables from production and change some that are
# needed to be changed
if [ "$CIRCLE_JOB" == 'deployment-qa' ]; then
  export REACT_APP_API_URL=$QA_API_URL
  export REACT_APP_AUTH_REDIRECT_URL=$QA_AUTH_REDIRECT_URL
fi
...
REACT_APP_SLACK_HELP_CHANNEL=$REACT_APP_SLACK_HELP_CHANNEL
